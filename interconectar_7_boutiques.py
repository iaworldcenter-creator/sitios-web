...
print("=" * 80)
print("SINCRONIZANDO NAVEGACIÓN CRUZADA Y BOTONES EXPLÍCITOS EN TODO EL ECOSISTEMA")
print("=" * 80)

# Barra de Navegación Cruzada Universal de las 8 Tiendas
NAV_CROSS_BAR_HTML = """
<nav class="hidden 2xl:flex items-center gap-1.5 text-[11px] font-bold text-slate-300">
    <a href="https://iaworldcenter-creator.github.io/sitios-web/" class="px-2.5 py-1 rounded-lg bg-amber-500/10 border border-amber-500/30 text-amber-400 hover:bg-amber-500 hover:text-slate-950 transition flex items-center gap-1"><i class="fa-solid fa-house text-[10px]"></i> Matriz</a>
    <a href="https://iaworldcenter-creator.github.io/pc-custom-lab/" class="px-2 py-1 rounded-lg hover:bg-slate-800 hover:text-cyan-400 transition flex items-center gap-1"><i class="fa-solid fa-microchip text-[10px] text-cyan-400"></i> PC Custom</a>
    <a href="https://iaworldcenter-creator.github.io/bazar-viamx-NFL.GDL/" class="px-2 py-1 rounded-lg hover:bg-slate-800 hover:text-cyan-300 transition flex items-center gap-1"><i class="fa-solid fa-gem text-[10px] text-cyan-300"></i> Vía MX</a>
    <a href="https://iaworldcenter-creator.github.io/cigarros-bazar/" class="px-2 py-1 rounded-lg hover:bg-slate-800 hover:text-amber-400 transition flex items-center gap-1"><i class="fa-solid fa-smoking text-[10px] text-amber-400"></i> Cigarros</a>
    <a href="https://iaworldcenter-creator.github.io/dulces-bazar/" class="px-2 py-1 rounded-lg hover:bg-slate-800 hover:text-pink-400 transition flex items-center gap-1"><i class="fa-solid fa-candy-cane text-[10px] text-pink-400"></i> Dulces</a>
    <a href="https://iaworldcenter-creator.github.io/kiosco-digital/" class="px-2 py-1 rounded-lg hover:bg-slate-800 hover:text-indigo-400 transition flex items-center gap-1"><i class="fa-solid fa-newspaper text-[10px] text-indigo-400"></i> Kiosco</a>
    <a href="https://iaworldcenter-creator.github.io/mi-puesto-bazar/" class="px-2 py-1 rounded-lg hover:bg-slate-800 hover:text-emerald-400 transition flex items-center gap-1"><i class="fa-solid fa-store text-[10px] text-emerald-400"></i> Mi Puesto</a>
    <a href="https://iaworldcenter-creator.github.io/ofertas-y-liquidaciones-/" class="px-2 py-1 rounded-lg hover:bg-slate-800 hover:text-red-400 transition flex items-center gap-1"><i class="fa-solid fa-tags text-[10px] text-red-400"></i> Liquidaciones</a>
</nav>
"""
...
boutiques_data = {
    ...
    "kiosco-digital": {
        ...
        "categories": [
            ...
            {"name": "Libros Digitales & Ebooks", "icon": "fa-book-open"}
        ],
        "products": [
...
<body class="bg-slate-950 text-slate-100 font-sans antialiased min-h-screen flex flex-col justify-between overflow-x-hidden selection:bg-cyan-500 selection:text-slate-950">
    ...
    <!-- ========================================================================
         1. CABECERA: NAVEGACIÓN CRUZADA DE LAS 8 BOUTIQUES + BUSCADOR SEARCH-FIRST
         ======================================================================== -->
    <header class="bg-slate-900/95 backdrop-blur border-b border-slate-800 sticky top-0 z-50 shadow-2xl">
        
        <!-- Nivel 1: Barra de Navegación Cruzada Completa (Interconexión de las 8 Tiendas) -->
        <div class="max-w-[99%] 2xl:max-w-[1850px] mx-auto px-4 py-2 flex flex-wrap items-center justify-between gap-2 text-xs border-b border-slate-800/80">
            ...
            <!-- ENLACES DIRECTOS A LAS 8 BOUTIQUES -->
            {NAV_CROSS_BAR_HTML}
        ...
        <div class="max-w-[99%] 2xl:max-w-[1850px] mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3.5 cursor-pointer shrink-0" onclick="document.getElementById('pie-de-pagina').scrollIntoView({{ behavior: 'smooth' }});">
                <div class="relative w-12 h-12 flex items-center justify-center">
                    <img 
                        ...
                        alt="Logo Tigre {data["name"]}" 
                        class="w-12 h-12 rounded-full object-cover border-2 border-amber-400 shadow-[0_0_15px_rgba(251,191,36,0.5)]"
                        onerror="this.src='https://iaworldcenter-creator.github.io/pc-custom-lab/assets/img/mascota_tigre.webp';"
                    />
                </div>
            ...
            <!-- Súper-Buscador Blanco Multi-Token con Botones Explícitos -->
            <div class="flex-1 max-w-3xl w-full relative">
                <div class="flex items-center bg-white rounded-full border-2 border-cyan-400 shadow-[0_0_22px_rgba(6,182,212,0.4)] px-4 py-1.5 gap-2">
                    ...
                    <input 
                        ...
                        autocomplete="off"
                        spellcheck="false"
                        placeholder="Busca en {data['name']} (ej. por producto, SKU, síntoma o marca)..." 
                ...
                <!-- Dropdown de Autocompletado con Botones Explícitos (Agregar al Carrito / Comprar Ahora) -->
    ...
    <main class="w-full max-w-[99%] 2xl:max-w-[1850px] mx-auto px-2 sm:px-4 py-8 flex-1">
        ...
        <div class="flex flex-col lg:flex-row gap-8 items-start justify-center">
            ...
            <!-- ESCAPARATE DE PRODUCTOS CON PRECIOS DE ALTO CONTRASTE Y BOTONES CLAROS -->
        ...
        <div class="absolute right-0 top-0 h-full w-full max-w-md bg-slate-900 border-l border-slate-800 shadow-2xl flex flex-col justify-between p-6 z-10">
            ...
            <div class="border-t border-slate-800 pt-4 flex flex-col gap-3">
                ...
                <a href="https://iaworldcenter-creator.github.io/pc-custom-lab/checkout.html" class="w-full bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 font-black py-3 rounded-xl text-xs uppercase tracking-wider transition active:scale-95 shadow-lg shadow-amber-500/20 cursor-pointer flex items-center justify-center gap-2 text-center">
                    <i class="fa-solid fa-credit-card"></i> Finalizar Compra Ahora
                </a>
            </div>
        </div>
    </div>
        ...
        container.innerHTML = boutiqueCategories.map(c => `
            ...
            >
                <div class="flex items-center gap-3.5 min-w-0">
                    <div class="w-8 h-8 rounded-xl bg-slate-900 flex items-center justify-center {data["color"]} shrink-0 shadow">
            ...
            return `
                <div class="bg-slate-950/90 hover:bg-slate-950 rounded-2xl p-3.5 flex flex-col justify-between transition group shadow-xl hover:shadow-[0_8px_30px_rgba(6,182,212,0.2)]">
                    ...
                    <div>
                        ...
                        <!-- BOTONES EXPLÍCITOS: AGREGAR AL CARRITO / COMPRAR AHORA -->
                        <div class="grid grid-cols-1 gap-2">
                            <button onclick="addToCartDirect('${{p.sku}}', 1)" class="w-full bg-slate-900 hover:bg-slate-800 text-cyan-300 font-bold py-2 px-2 rounded-xl text-[11px] flex items-center justify-center gap-1.5 transition active:scale-95 cursor-pointer shadow border border-cyan-500/30" title="Agregar este producto a tu canasta">
                                <i class="fa-solid fa-cart-plus text-xs"></i> <span>Agregar al Carrito</span>
                            </button>
                            <button onclick="buyNowDirect('${{p.sku}}')" class="w-full bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 font-black py-2 px-2 rounded-xl text-[11px] flex items-center justify-center gap-1.5 transition active:scale-95 shadow cursor-pointer" title="Comprar y pagar ahora mismo">
        ...
        box.innerHTML = matches.slice(0, 5).map(item => `
            <div class="bg-slate-950 rounded-xl p-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 transition shadow border border-slate-800/80">
                ...
                <div class="flex items-center gap-2 w-full sm:w-auto justify-end shrink-0">
                    <button onclick="addToCartDirect('${{item.sku}}', 1)" class="bg-slate-800 hover:bg-slate-700 text-cyan-300 font-bold px-3 py-1.5 rounded-lg text-[10px] flex items-center gap-1 transition active:scale-95 shadow border border-cyan-500/30">
                        <i class="fa-solid fa-cart-plus"></i> <span>Agregar</span>
                    </button>
                    <button onclick="buyNowDirect('${{item.sku}}')" class="bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 text-slate-950 font-black px-3.5 py-1.5 rounded-lg text-[10px] flex items-center gap-1 transition active:scale-95 shadow">
                        <i class="fa-solid fa-bag-shopping"></i> <span>Comprar Ahora</span>
                    </button>
                </div>
            </div>
        `).join('');
...
for key, b_info in boutiques_data.items():
    ...
    if matched_dir:
        ...
        print(f"✓ Boutique interconectada: [{b_info['name']}] en {target_path}")
        ...
        if os.path.exists(os.path.join(sub_repo, ".git")):
            ...
            subprocess.run(["git", "commit", "-m", f"feat(boutique): {b_info['name']} con barra cruzada 8 tiendas y botones explicitos", "--allow-empty"], cwd=sub_repo, capture_output=True)
...
# 2. Desplegar Monorepositorio Central
print("\n=== DESPLEGANDO MONOREPOSITORIO CENTRAL ===")
subprocess.run(["git", "add", "-A"], cwd=BASE_DIR, check=True)
subprocess.run(["git", "commit", "-m", "feat(ecosistema): 7 boutiques con navegacion cruzada completa y botones explicitos desplegadas", "--allow-empty"], cwd=BASE_DIR, capture_output=True)

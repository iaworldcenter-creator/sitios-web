...
subprocess.run(["git", "commit", "-m", "fix(sidebar): restauracion completa de 24 departamentos con botones Aplicar/Limpiar y 3 tarjetas sin scroll interno"], cwd=PC_DIR)
...
subprocess.run(["git", "commit", "-m", "fix(ecosistema): restauracion de 24 departamentos y botones en PC Custom Lab"], cwd=BASE_DIR)

...
print("=" * 80, flush=True)
print("ESTRATEGIA DE OPTIMIZACIÓN DE ÉLITE: ESTABILIDAD VISUAL, INP Y ACCESIBILIDAD UNIVERSAL")
print("=" * 80, flush=True)

# 1. ACTUALIZAR CSS CON ANULACIONES MÉTRICAS TIPOGRÁFICAS (FONT METRIC OVERRIDES) Y ASPECT-RATIO ESTRICTO
with open(CSS_FILE, "r", encoding="utf-8") as f:
    base_css = f.read()

ELITE_OPTIMIZATION_CSS = """
/* === INGENIERÍA DE ESTABILIDAD VISUAL (CLS < 0.05) & ACCESIBILIDAD UNIVERSAL === */
.product-img-wrapper {
...
/* Áreas de contacto calibradas >= 48px (superando el umbral de 24px para WCAG 2.2) */
...
/* Anulaciones métricas de fuentes tipográficas para cero saltos FOUT */
@font-face {
...
if 'ascent-override' not in base_css:
    base_css += ELITE_OPTIMIZATION_CSS

# 2. GENERAR INDEX.HTML CON ARQUITECTURA SEMÁNTICA INTACTA
HTML_ELITE = """<!DOCTYPE html>
...
<head>
    ...
    <!-- Carga Asíncrona con Preload de Fuentes -->
    <link rel="preload" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"></noscript>

    <!-- CSS Crítico Inyectado Directamente en Head (Cero Render-Blocking) -->
    <style>
""" + base_css + """
    </style>
</head>
<body class="bg-slate-950 text-slate-100 font-sans min-h-screen flex flex-col antialiased">
    ...
    <header class="sticky top-0 z-50 bg-slate-950/95 backdrop-blur-md border-b border-slate-800 shadow-xl">
        ...
        <div class="w-full max-w-[1850px] mx-auto px-2 sm:px-4 py-2 border-b border-slate-900/80 flex items-center justify-between gap-2 overflow-x-auto no-scrollbar scroll-smooth">
            ...
            <nav class="flex items-center gap-1.5 shrink-0 text-xs font-mono font-bold" aria-label="Ecosistema de Tiendas">
                <a href="https://iaworldcenter-creator.github.io/sitios-web/" aria-label="Ir al portal matriz" class="px-2.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-800 transition min-h-[48px] flex items-center">
                    <i class="fa-solid fa-house text-amber-400 mr-1.5" aria-hidden="true"></i> Matriz
                </a>
                <a href="https://iaworldcenter-creator.github.io/VECTEC/" aria-label="Tienda activa VECTEC" class="px-3 py-1.5 rounded-xl bg-cyan-950/80 text-cyan-300 font-black neon-glow-pc transition min-h-[48px] flex items-center">
                    <i class="fa-solid fa-microchip text-cyan-400 mr-1.5" aria-hidden="true"></i> PC Custom
                </a>
                <a href="https://iaworldcenter-creator.github.io/bazar-viamx-NFL.GDL/" aria-label="Ir a boutique Vía MX" class="px-2.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-800 transition min-h-[48px] flex items-center">
                    <i class="fa-solid fa-gem text-cyan-300 mr-1.5" aria-hidden="true"></i> Vía MX
                </a>
                <a href="https://iaworldcenter-creator.github.io/cigarros-bazar/" aria-label="Ir a boutique Cigarros Bazar" class="px-2.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-800 transition min-h-[48px] flex items-center">
                    <i class="fa-solid fa-smoking text-amber-400 mr-1.5" aria-hidden="true"></i> Cigarros
                </a>
                <a href="https://iaworldcenter-creator.github.io/dulces-bazar/" aria-label="Ir a boutique Dulces Bazar" class="px-2.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-800 transition min-h-[48px] flex items-center">
                    <i class="fa-solid fa-candy-cane text-pink-400 mr-1.5" aria-hidden="true"></i> Dulces
                </a>
                <a href="https://iaworldcenter-creator.github.io/kiosco-digital/" aria-label="Ir a Kiosco Digital" class="px-2.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-800 transition min-h-[48px] flex items-center">
                    <i class="fa-solid fa-newspaper text-indigo-400 mr-1.5" aria-hidden="true"></i> Kiosco
                </a>
                <a href="https://iaworldcenter-creator.github.io/mi-puesto-bazar/" aria-label="Ir a Mi Puesto Bazar" class="px-2.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-800 transition min-h-[48px] flex items-center">
                    <i class="fa-solid fa-store text-emerald-400 mr-1.5" aria-hidden="true"></i> Mi Puesto
                </a>
                <a href="https://iaworldcenter-creator.github.io/ofertas-y-liquidaciones-/" aria-label="Ir a Ofertas y Liquidaciones" class="px-2.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-800 transition min-h-[48px] flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 pb-10 border-b border-slate-800/80">
                ...
                <div class="space-y-3">
                    ...
                    <div class="pt-2 border-t border-slate-900 space-y-1.5 text-[10.5px]">
                        <a href="https://www.facebook.com/profile.php?id=61593020515115" target="_blank" rel="noopener" aria-label="Perfil oficial de Facebook" class="text-slate-300 hover:text-blue-400 flex items-center gap-2 transition min-h-[44px]">
                        ...
                        <a href="https://www.instagram.com/pccustomlab/" target="_blank" rel="noopener" aria-label="Perfil oficial de Instagram" class="text-slate-300 hover:text-pink-400 flex items-center gap-2 transition min-h-[44px]">
                        ...
                        <a href="https://www.youtube.com/@IAWorldCenter" target="_blank" rel="noopener" aria-label="Canal oficial de YouTube" class="text-slate-300 hover:text-red-400 flex items-center gap-2 transition min-h-[44px]">
                        ...
                        <a href="https://t.me/vectec_gdl" target="_blank" rel="noopener" aria-label="Canal oficial de Telegram" class="text-slate-300 hover:text-cyan-400 flex items-center gap-2 transition min-h-[44px]">
    ...
    <script src="js/ct-catalog-data.js?v=20260828_2130"></script>
    <script defer src="js/ct-exact-catalog-engine.js?v=20260828_2130"></script>
</body>
</html>
"""
...
print("✅ index.html reescrito con arquitectura de accesibilidad y estabilidad visual.", flush=True)

# 3. ACTUALIZAR JS ENGINE CON SCHEDULER.YIELD / REQUESTIDLECALLBACK RESILIENTE Y VALIDACIONES DEFENSIVAS (CERO EXCEPCIONES)
ENGINE_JS_ELITE = """// =========================================================================
// MOTOR ULTRA RÁPIDO VECTEC (OPTIMIZACIÓN DE ÉLITE / INP & CLS ZERO)
// =========================================================================
...
document.addEventListener("DOMContentLoaded", () => {
    try {
        ...
        console.warn("[VECTEC Engine] Inicialización protegida:", err);
    }
});
...
with open(ENGINE_JS, "w", encoding="utf-8") as f:
    f.write(ENGINE_JS_ELITE)

print("✅ ct-exact-catalog-engine.js optimizado con scheduler.yield / fallback y cero excepciones.", flush=True)

# 4. Sincronizar espejo a OneDrive C:

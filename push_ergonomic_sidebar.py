...
subprocess.run(["git", "commit", "-m", "feat(ux): barra lateral ultra-ergonomica de vista completa 100% visible sin scroll interno, sticky en pantalla con QR, Gemini y Anti-Gravity"], cwd=PC_DIR)
...
subprocess.run(["git", "commit", "-m", "fix(ecosistema): sincronizacion de sidebar ultra-ergonomico sin scroll interno en PC Custom Lab"], cwd=BASE_DIR)

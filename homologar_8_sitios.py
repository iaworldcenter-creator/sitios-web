...
print("=" * 80)
print("HOMOLOGANDO LOS 8 SITIOS: COTIZADOR UBER COMPLETO + CARRUSEL 2-COLS CON FLECHAS")
print("=" * 80)

# Barra de navegación deslizable universal
NAV_BAR_HTML = """
...
# Módulo del Cotizador Uber Flash con validación estricta
COTIZADOR_HTML = """
<div class="bg-slate-900 border border-slate-800 p-4 rounded-3xl shadow-xl space-y-3 mb-6">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
        <span class="text-xs font-mono font-bold text-white flex items-center gap-1.5">
            <i class="fa-brands fa-uber text-white"></i> Cotizar Envío Uber Flash a tu Domicilio
        </span>
        <span id="shipping-rate-badge" class="text-xs font-mono font-bold text-slate-400 bg-slate-950 px-2.5 py-1 rounded-lg border border-slate-800">
            Pendiente Cotizar
        </span>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 text-xs">
        <div>
            ...
            <input type="text" id="inputCalle" placeholder="Ej. Av. Juárez, Hidalgo..." class="w-full bg-slate-950 border border-slate-800 rounded-xl p-2 text-white outline-none focus:border-cyan-400" />
        </div>
        <div>
        ...
        <div>
            <label class="text-[10px] font-mono text-slate-400 block mb-0.5">Municipio / Zona:</label>
    ...
    <div id="address-error-box" class="hidden p-2.5 rounded-xl bg-amber-950/60 border border-amber-500/50 text-amber-300 text-xs font-mono leading-tight"></div>

    <div class="flex flex-col sm:flex-row items-center justify-between gap-3 pt-1">
        <span id="distance-calc-info" class="text-[11px] font-mono text-slate-400">
            <i class="fa-solid fa-location-dot text-amber-400 mr-1"></i> Despacho directo desde Pedro Moreno 501 A
        </span>
        <button onclick="quoteShippingUniversal()" class="w-full sm:w-auto bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 text-slate-950 font-black px-6 py-2.5 rounded-xl text-xs uppercase tracking-wider transition active:scale-95 shadow cursor-pointer flex items-center justify-center gap-1.5">
...
# Configuración y Productos de las 7 Boutiques
boutiques_data = {
    "pc-custom-lab": {
        ...
        "products": [
            ...
            {"sku": "PC-006", "nombre": "Tarjeta Gráfica NVIDIA RTX 4070 Ti Super 16GB", "marca": "NVIDIA", "precio": 17800.00, "original": 21500.00, "desc": "DLSS 3, Ray Tracing y 16GB GDDR6X para renderizado y gaming 4K.", "img": "https://iaworldcenter-creator.github.io/pc-custom-lab/assets/img/catalog/gpu_nvidia.webp", "tokens": ["gpu", "nvidia", "rtx", "4070", "grafica"]}
        ]
    },
    "bazar-viamx-nfl.gdl": {
        ...
        "products": [
            {"sku": "VMX-001", "nombre": "Pantalla Smart TV 55 Pulgadas 4K UHD HDR10+ WiFi", "marca": "Samsung", "precio": 7999.00, "original": 11499.00, "desc": "Panel LED 4K ultra nítido con asistente de voz y 4 puertos HDMI.", "img": "https://iaworldcenter-creator.github.io/pc-custom-lab/assets/img/catalog/monitor_curvo_negro.webp", "tokens": ["pantalla", "smart tv", "samsung", "4k"]},
    ...
    "cigarros-bazar": {
        ...
        "products": [
            ...
            {"sku": "CIG-002", "nombre": "Cigarros Benson & Hedges Black Switch (Cajetilla 20)", "marca": "Benson & Hedges", "precio": 88.00, "original": 105.00, "desc": "Cápsula de sabor mentolado con tabaco curado de alta calidad.", "img": "https://iaworldcenter-creator.github.io/pc-custom-lab/assets/img/tigre_corporativo_thumb.webp", "tokens": ["cigarros", "benson", "hedges", "mentolados"]},
    ...
    "dulces-bazar": {
        ...
        "products": [
            ...
            {"sku": "DUL-003", "nombre": "Rocaleta Sonrics con Centro de Goma (Bolsa 30)", "marca": "Sonrics", "precio": 185.00, "original": 230.00, "desc": "Caramelo con 4 capas de chile ácido y centro masticable.", "img": "assets/img/mascota_tigre_thumb.webp", "tokens": ["rocaleta", "sonrics", "chile", "paleta"]},
    ...
    "mi-puesto-bazar": {
        ...
        "products": [
            {"sku": "PUE-001", "nombre": "Lentes Inteligentes Bluetooth con Audio y Micrófono", "marca": "SmartVision", "precio": 680.00, "original": 950.00, "desc": "Contesta llamadas, sube volumen y música con protección UV.", "img": "https://iaworldcenter-creator.github.io/pc-custom-lab/assets/img/tigre_gamer_thumb.webp", "tokens": ["lentes", "inteligentes", "bluetooth", "audio"]},
            {"sku": "PUE-002", "nombre": "Consola Retro Portátil con 500 Juegos Clásicos", "marca": "Sup Game", "precio": 290.00, "original": 390.00, "desc": "Batería recargable y salida para conectar a la TV con cable AV.", "img": "https://iaworldcenter-creator.github.io/pc-custom-lab/assets/img/tigre_gemini_thumb.webp", "tokens": ["consola", "retro", "videojuegos", "juegos"]},
            {"sku": "PUE-003", "nombre": "Cable de Carga Rápida USB-C a USB-C de 65W Reforzado", "marca": "Baseus", "precio": 120.00, "original": 180.00, "desc": "Cable trenzado de nailon compatible con celulares y laptops.", "img": "https://iaworldcenter-creator.github.io/pc-custom-lab/assets/img/catalog/fuente_modular.webp", "tokens": ["cable", "cargador", "usb c", "carga rapida"]}
        ]
    },
    "ofertas-y-liquidaciones": {
        ...
        "products": [
            ...
            {"sku": "OFE-002", "nombre": "Monitor Curvo 24 Pulgadas 144Hz Full HD Exhibición", "marca": "AOC", "precio": 2100.00, "original": 3200.00, "desc": "Equipo de vitrina estética 10/10 con caja original y cables.", "img": "https://iaworldcenter-creator.github.io/pc-custom-lab/assets/img/catalog/monitor_curvo_negro.webp", "tokens": ["monitor", "curvo", "aoc", "144hz"]},
...
<body class="bg-slate-950 text-slate-100 font-sans antialiased min-h-screen flex flex-col justify-between overflow-x-hidden selection:bg-cyan-500 selection:text-slate-950">
    ...
    <main class="w-full max-w-[99%] 2xl:max-w-[1850px] mx-auto px-2 sm:px-4 py-8 flex-1">
        ...
        <!-- COTIZADOR UBER COMPLETO EN TODAS LAS BOUTIQUES -->
        {COTIZADOR_HTML}
        ...
        <div class="flex flex-col lg:flex-row gap-8 items-start justify-center">
            ...
            <!-- ESCAPARATE CON 2 PRODUCTOS EN MÓVIL + FLECHAS FLOTANTES -->
            <section class="flex-1 w-full flex flex-col gap-4 min-w-0">
                ...
                <div class="relative">
                    ...
                    <!-- Carrusel de 2 productos por pantalla en móvil / 5 cols en desktop -->
    ...
    function quoteShippingUniversal() {{
        ...
        const errBox = document.getElementById("address-error-box");
        const badge = document.getElementById("shipping-rate-badge");

        if (!calle) {{ showErr("⚠️ Falta escribir la calle o avenida."); return; }}
        if (!num) {{ showErr("⚠️ Falta el número exterior / interior de tu domicilio o taller."); return; }}
        if (!col) {{ showErr("⚠️ Falta la colonia o barrio."); return; }}
        if (!mun) {{ showErr("⚠️ Falta seleccionar el municipio."); return; }}

        errBox.classList.add("hidden");
        let rate = 35;
        let dist = "1.8 km (Guadalajara Centro)";

        if (mun === "zapopan") {{ rate = 52; dist = "4.8 km (Zapopan/Poniente)"; }}
        else if (mun === "tlaquepaque") {{ rate = 48; dist = "4.5 km (Tlaquepaque)"; }}
        else if (mun === "tonala") {{ rate = 70; dist = "9.2 km (Tonalá)"; }}
        else if (mun === "tlajomulco") {{ rate = 125; dist = "18.5 km (Tlajomulco Sur/Payuca)"; }}
        else if (mun === "elsalto") {{ rate = 135; dist = "21.0 km (El Salto)"; }}

        badge.innerText = `$${{rate.toFixed(2)}} MXN`;
        badge.className = "text-xs font-mono font-black text-emerald-400 bg-emerald-950/60 px-3 py-1 rounded-lg border border-emerald-500/40";
        document.getElementById("distance-calc-info").innerHTML = `🛵 <strong class="text-emerald-400">Uber Flash:</strong> ${{calle}} #${{num}}, Col. ${{col}} (~${{dist}})`;
        localStorage.setItem("user_last_shipping_quote", JSON.stringify({{ rate, calle, num, col, mun, dist }}));
    }}
...
for key, b_info in boutiques_data.items():
    for d in all_dirs:
        if b_info["folder_pattern"].lower() in d.lower() and os.path.isdir(os.path.join(BASE_DIR, d)):
            ...
            print(f"✓ Boutique {d} actualizada con Cotizador Uber completo y Carrusel 2-Cols.")
            ...
            if os.path.exists(os.path.join(sub_repo, ".git")):
                ...
                subprocess.run(["git", "commit", "-m", "feat(ux): cotizador Uber estricto y carrusel 2 cols con flechas", "--allow-empty"], cwd=sub_repo, capture_output=True)
...
# 2. Reconstruir Portal Matriz (index.html y sitios-web/index.html) con Cotizador Uber y Carrusel Horizontal
...
<head>
    ...
    <meta name="description" content="Hub central BAZAR NFL.GDL: 7 boutiques en Pedro Moreno 501 A, Guadalajara Centro con Cotizador Uber Flash y Carrito Unificado." />
...
<body class="bg-slate-950 text-slate-100 font-sans antialiased min-h-screen flex flex-col justify-between overflow-x-hidden selection:bg-cyan-500 selection:text-slate-950">
    ...
    <main class="w-full max-w-[99%] 2xl:max-w-[1850px] mx-auto px-2 sm:px-4 py-8 flex-1">
        ...
        <!-- COTIZADOR UBER COMPLETO EN EL PORTAL MATRIZ -->
        {COTIZADOR_HTML}
        ...
        container.innerHTML = boutiquesConfig.map(b => {{
            ...
            return `
                <div class="bg-slate-900/50 rounded-3xl p-5 shadow-2xl space-y-4">
                    ...
                    <!-- CARRUSEL DE 2 PRODUCTOS EN MÓVIL CON FLECHAS FLOTANTES -->
                    <div class="relative">
...
for p in [os.path.join(BASE_DIR, "index.html"), os.path.join(BASE_DIR, "sitios-web", "index.html")]:
    if os.path.exists(os.path.dirname(p)):
        ...
        print(f"✓ Portal Matriz actualizado con Cotizador Uber y Carrusel 2-Cols: {p}")
...
if os.path.exists(os.path.join(sitios_repo, ".git")):
    ...
    subprocess.run(["git", "commit", "-m", "feat(ecosistema): cotizador Uber estricto y carrusel 2 cols con flechas desplegados", "--allow-empty"], cwd=sitios_repo, capture_output=True)
...
subprocess.run(["git", "commit", "-m", "feat(ecosistema): 8 portales homologados con Cotizador Uber Flash y carrusel 2 productos", "--allow-empty"], cwd=BASE_DIR, capture_output=True)
